...
% Last Modified by GUIDE v2.5 10-Apr-2018 14:16:37
...
if (bool)   set(handles.streamStatusText,'ForegroundColor',[0.4 0.8 0.4]);
            set(handles.streamStatusText,'String','CBMEX open');
            set(handles.startStreamButton,'String','Stop CBMEX');
else        set(handles.streamStatusText,'ForegroundColor',[0.8 0.4 0.4]);
            set(handles.streamStatusText,'String','CBMEX closed');
            set(handles.startStreamButton,'String','Start CBMEX');
end

% for test purposes: start raster plot
updateRasterAxes(handles);


function updateRasterAxes(handles)
